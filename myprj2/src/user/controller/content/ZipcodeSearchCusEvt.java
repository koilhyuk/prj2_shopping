...
public class ZipcodeSearchCusEvt extends MouseAdapter implements ActionListener {
	public static final int DOUBLE_CLICK = 2;

	private UserCusDataView ucv;
	private ZipcodeSearchCusView zsov;

	private String sidoName;
	private String gugunName;
	private String inputAddrName;

	public ZipcodeSearchCusEvt(UserCusDataView ucv, ZipcodeSearchCusView zsov) {
		this.ucv = ucv;
		this.zsov = zsov;
	}// ZipcodeSearchEvt
