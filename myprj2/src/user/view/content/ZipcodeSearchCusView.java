...
public class ZipcodeSearchCusView extends JDialog {
	...
	public ZipcodeSearchCusView(UserCusDataView ucv) {
		super(ucv, "주소검색", true);
		this.ucv = ucv;
		...
		ZipcodeSearchCusEvt zsoe = new ZipcodeSearchCusEvt(ucv, this);
